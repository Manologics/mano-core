...
export default function AgentRetention() {
  return (
    <div style={{ display:"flex", minHeight:"100vh", background:"#0a0a0a", color:"#e0e0e0", fontFamily:"'Inter','Segoe UI',sans-serif" }}>
      <Sidebar current="/AgentRetention" />
      <main style={{ flex:1, padding:"28px" }}>
        <div style={{ fontFamily:"monospace", fontSize:"10px", color:"#00ff88", letterSpacing:"3px", marginBottom:"6px" }}>AGENT 04</div>
        <h1 style={{ fontSize:"22px", fontWeight:"700", color:"#fff", margin:"0 0 6px" }}>Retention Agent</h1>
        <p style={{ color:"#555", fontSize:"13px", marginBottom:"36px" }}>Re-engages past clients and drives repeat business through retention campaigns.</p>
        <div style={{ background:"#111", border:"1px dashed #1f1f1f", borderRadius:"16px", padding:"70px 40px", textAlign:"center" }}>
          <div style={{ fontSize:"44px", marginBottom:"14px" }}>🤖</div>
          <div style={{ fontFamily:"monospace", fontSize:"13px", color:"#333", letterSpacing:"2px" }}>AGENT AWAITING DEPLOYMENT</div>
