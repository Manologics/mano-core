  ...
  <style>{`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .gold-glow-btn:hover {
      ...
      box-shadow: 0 0 70px #f5c518cc, 0 0 120px #f5c51866 !important;
    ...
    >
      <div style={{ background:"#0e0e0e",border:`1px solid ${GOLD}35`,borderRadius:"18px",padding:"clamp(24px,5vw,40px) clamp(20px,5vw,36px)",maxWidth:"480px",width:"100%",position:"relative",boxShadow:`0 0 80px ${GOLD}14, 0 40px 80px rgba(0,0,0,0.9)` }}>
        ...
        {step===1 && <>
          ...
          <h2 style={{ fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(26px,5vw,34px)",color:WHITE,margin:"0 0 6px",letterSpacing:"1px",lineHeight:1.1,textShadow:"0 0 20px rgba(255,255,255,0.1)" }}>How much are you losing?</h2>
        ...
        {step===2 && <>
          ...
          <div style={{ background:`linear-gradient(135deg,${RED}18,#080404)`,border:`1px solid ${RED}44`,borderRadius:"10px",padding:"16px 18px",marginBottom:"28px",boxShadow:`0 0 28px ${RED}14` }}>
            <div style={{ fontFamily:"'DM Sans',sans-serif",fontSize:"14px",color:LIGHT,fontWeight:"600",lineHeight:1.6 }}>
              That's <strong style={{ color:REDB,textShadow:`0 0 8px ${RED}55` }}>{fmt(missedMonthly * 12)}/year</strong> going straight to competitors who answer their phone.
            </div>
          </div>
        ...
        <button onClick={onClose} style={{ position:"absolute",top:"16px",right:"20px",background:"none",border:"none",color:DIM,fontSize:"22px",cursor:"pointer",lineHeight:1,transition:"color 0.2s" }}
  ...
  return (
    <div style={{ minHeight:"100vh",background:"#060606",color:LIGHT }}>
      ...
      <section style={{ maxWidth:"880px",margin:"0 auto",padding:"92px 24px 64px",textAlign:"center" }}>
        ...
        <h1 style={{ fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(52px,9vw,108px)",color:WHITE,lineHeight:0.95,margin:"0 0 24px",letterSpacing:"2px",textShadow:"0 0 40px rgba(255,255,255,0.08)" }}>
        ...
        <p style={{ fontFamily:"'DM Sans',sans-serif",fontSize:"16px",color:REDB,maxWidth:"480px",margin:"0 auto 18px",lineHeight:1.6,fontWeight:"500",fontStyle:"italic",opacity:0.9 }}>
          While you're missing calls, your competitors are closing them.
        </p>

        <p style={{ fontFamily:"'DM Sans',sans-serif",fontSize:"17px",color:MID,maxWidth:"500px",margin:"0 auto 16px",lineHeight:1.8,fontWeight:"400" }}>
      ...
      <div style={{ maxWidth:"880px",margin:"0 auto 72px",padding:"0 24px" }}>
        <div style={{ background:`linear-gradient(135deg,${RED}18,#0a0808 60%,${RED}0c)`,border:`1px solid ${RED}44`,borderRadius:"14px",padding:"28px 36px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"24px",boxShadow:`0 0 40px ${RED}14` }}>
          <div style={{ flex:1,minWidth:"220px" }}>
            ...
            <div style={{ fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(22px,3.5vw,34px)",color:WHITE,letterSpacing:"1px",lineHeight:1.1,textShadow:"0 0 20px rgba(255,255,255,0.05)" }}>
              Every missed call is a job your{" "}
              <span style={{ color:REDB,textShadow:`0 0 12px ${RED}77` }}>competitor</span>{" "}books.
            </div>
          </div>
          <div style={{ textAlign:"center",padding:"0 8px" }}>
            <div className="red-loss" style={{ fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(44px,7vw,72px)",color:WHITE,lineHeight:1,textShadow:`0 0 20px ${REDB}` }}>73%</div>
      ...
      {/* HOW IT WORKS */}
      <section style={{ background:"#0a0a0a",borderTop:"1px solid #1a1a1a",borderBottom:"1px solid #1a1a1a",padding:"72px 24px" }}>
      ...
      <section style={{ padding:"96px 24px",textAlign:"center" }}>
        <div style={{ maxWidth:"580px",margin:"0 auto" }}>
          ...
          <div style={{ marginTop:"18px",fontFamily:"'Space Mono',monospace",fontSize:"10px",color:"#444",letterSpacing:"1px" }}>Free 30-min walkthrough. No pressure.</div>
        </div>
      </section>

      {/* FOOTER */}
      <footer style={{ borderTop:"1px solid #1a1a1a",padding:"28px 28px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:"8px" }}>
        <div>
