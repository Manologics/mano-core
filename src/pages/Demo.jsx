  ...
  return (
    ...
    >
      <div style={{ background:"#0c0c0c",border:`1px solid ${GOLD}33`,borderRadius:"18px",padding:"clamp(24px,5vw,40px) clamp(20px,5vw,36px)",maxWidth:"480px",width:"100%",position:"relative",boxShadow:`0 0 80px ${GOLD}18, 0 40px 80px rgba(0,0,0,0.8)` }}>
        ...
        {/* STEP 1 */}
        {step===1 && <>
          <div style={{ fontFamily:"'Space Mono',monospace",fontSize:"10px",color:GOLD,letterSpacing:"3px",marginBottom:"10px" }}>STEP 1 OF 3</div>
          <h2 style={{ fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(26px,5vw,34px)",color:WHITE,margin:"0 0 6px",letterSpacing:"1px",lineHeight:1.1,textShadow:"0 0 20px rgba(255,255,255,0.08)" }}>How much are you losing?</h2>
          <p style={{ fontFamily:"'DM Sans',sans-serif",fontSize:"14px",color:MID,margin:"0 0 24px",lineHeight:1.65 }}>Enter your numbers and we'll calculate your exact monthly loss.</p>
          ...
          <div style={{ display:"flex",flexDirection:"column",gap:"14px",marginBottom:"28px" }}>
            <div>
              ...
              <input
                ...
                style={{ ...INP, border:`1px solid ${calls?GOLD+"66":"#333"}`, color:GOLD, fontFamily:"'Bebas Neue',sans-serif", fontSize:"40px", textAlign:"center", padding:"20px 16px", boxShadow:calls?`inset 0 0 20px ${GOLD}10`:"none" }}
              />
            </div>
            <div>
        ...
        {step===2 && <>
          ...
          <div style={{ textAlign:"center",padding:"20px 0 28px" }}>
            ...
            <div style={{ fontFamily:"'DM Sans',sans-serif",fontSize:"16px",color:LIGHT,fontWeight:"500" }}>per month in missed calls.</div>
          </div>
          ...
          <div style={{ background:`linear-gradient(135deg,${RED}18,#080404)`,border:`1px solid ${RED}44`,borderRadius:"10px",padding:"16px 18px",marginBottom:"28px",boxShadow:`0 0 28px ${RED}14` }}>
            <div style={{ fontFamily:"'DM Sans',sans-serif",fontSize:"14px",color:WHITE,fontWeight:"600",lineHeight:1.6 }}>
              That's <strong style={{ color:REDB }}>{formatMoney(missedMonthly * 12)}/year</strong> going straight to competitors who answer their phone.
            </div>
          </div>
        ...
        {step===3 && !submitted && <>
          ...
          <p style={{ fontFamily:"'DM Sans',sans-serif",fontSize:"14px",color:MID,margin:"0 0 22px",lineHeight:1.65 }}>We'll reach out to show you how Mano recovers your <strong style={{ color:REDB }}>{formatMoney(missedMonthly)}/mo</strong> in missed jobs.</p>
