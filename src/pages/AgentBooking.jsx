...
export default function AgentBooking() {
  return (
    <div style={{ display:"flex", minHeight:"100vh", background:"#0a0a0a", color:"#e0e0e0", fontFamily:"'Inter','Segoe UI',sans-serif" }}>
      <Sidebar current="/AgentBooking" />
      <main style={{ flex:1, padding:"28px" }}>
        <div style={{ fontFamily:"monospace", fontSize:"10px", color:"#00ff88", letterSpacing:"3px", marginBottom:"6px" }}>AGENT 02</div>
        <h1 style={{ fontSize:"22px", fontWeight:"700", color:"#fff", margin:"0 0 6px" }}>Booking Agent</h1>
        <p style={{ color:"#555", fontSize:"13px", marginBottom:"36px" }}>Manages appointments, scheduling, and booking confirmations.</p>
